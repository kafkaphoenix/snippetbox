...
import (
	...
	"github.com/kafkaphoenix/snippetbox/internal/models/mocks"
)
...
func newTestServer(t *testing.T, h http.Handler) *testServer {
	...
	// By always returning a http.ErrUseLastResponse error it forces the
	// client to immediately return the received response.
